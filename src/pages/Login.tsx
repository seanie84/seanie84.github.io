...
const STATUSES = ['CORE ONLINE', '77 AGENTS STANDING BY', 'AWAITING OPERATOR'];
      ...
      <div style={{ position: 'relative', zIndex: 1, width: '100%', maxWidth: 420 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          <div style={{
            ...
            <span style={{ fontFamily: 'Orbitron', fontWeight: 900, fontSize: 24, color: '#000' }}>N</span>
          </div>
          <h1 style={{ fontFamily: 'Orbitron', fontWeight: 700, fontSize: 22, color: 'var(--ink)', letterSpacing: '0.12em', marginBottom: 6 }}>NEXA</h1>
          <p style={{ fontFamily: 'JetBrains Mono', fontSize: 11, color: 'var(--cyan)', letterSpacing: '0.22em', textTransform: 'uppercase' }}>
            {STATUSES[statusIdx]}
          </p>
        </div>
        ...
        <div className="glass" style={{ padding: 32, boxShadow: 'var(--elev-glow)' }}>
          <h2 style={{ fontFamily: 'Rajdhani', fontWeight: 700, fontSize: 18, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--ink)', marginBottom: 24 }}>
            Operator Sign-In
          </h2>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            {error && (
              <p style={{ fontFamily: 'JetBrains Mono', fontSize: 11, color: 'var(--danger)', padding: '10px 12px', background: 'rgba(251,113,133,0.08)', borderRadius: 8, border: '1px solid rgba(251,113,133,0.2)' }}>
                {error}
              </p>
            )}
